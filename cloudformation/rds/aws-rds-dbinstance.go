...
type DBInstance struct {
	...
	AllowMajorVersionUpgrade *utils.Value[bool] `json:"AllowMajorVersionUpgrade,omitempty"`
	...
	DeleteAutomatedBackups *utils.Value[bool] `json:"DeleteAutomatedBackups,omitempty"`
	...
	EnablePerformanceInsights *utils.Value[bool] `json:"EnablePerformanceInsights,omitempty"`
	...
	MaxAllocatedStorage *utils.Value[int] `json:"MaxAllocatedStorage,omitempty"`
	...
	MonitoringInterval *utils.Value[int] `json:"MonitoringInterval,omitempty"`
	...
	MultiAZ *utils.Value[bool] `json:"MultiAZ,omitempty"`
	...
	PerformanceInsightsRetentionPeriod *utils.Value[int] `json:"PerformanceInsightsRetentionPeriod,omitempty"`
	...
	PromotionTier *utils.Value[int] `json:"PromotionTier,omitempty"`
	...
	UseDefaultProcessorFeatures *utils.Value[bool] `json:"UseDefaultProcessorFeatures,omitempty"`
