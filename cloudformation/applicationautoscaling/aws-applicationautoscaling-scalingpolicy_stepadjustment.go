...
type ScalingPolicy_StepAdjustment struct {
	...
	MetricIntervalLowerBound *utils.Value[float64] `json:"MetricIntervalLowerBound,omitempty"`
	...
	MetricIntervalUpperBound *utils.Value[float64] `json:"MetricIntervalUpperBound,omitempty"`
	...
	ScalingAdjustment *utils.Value[int] `json:"ScalingAdjustment"`
