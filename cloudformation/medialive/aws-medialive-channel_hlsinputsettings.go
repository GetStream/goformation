...
type Channel_HlsInputSettings struct {
	...
	Bandwidth *utils.Value[int] `json:"Bandwidth,omitempty"`
	...
	BufferSegments *utils.Value[int] `json:"BufferSegments,omitempty"`
	...
	Retries *utils.Value[int] `json:"Retries,omitempty"`
