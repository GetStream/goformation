...
type CloudFormationProvisionedProduct_ProvisioningPreferences struct {
	...
	StackSetFailureToleranceCount *utils.Value[int] `json:"StackSetFailureToleranceCount,omitempty"`
	...
	StackSetFailureTolerancePercentage *utils.Value[int] `json:"StackSetFailureTolerancePercentage,omitempty"`
	...
	StackSetMaxConcurrencyCount *utils.Value[int] `json:"StackSetMaxConcurrencyCount,omitempty"`
	...
	StackSetMaxConcurrencyPercentage *utils.Value[int] `json:"StackSetMaxConcurrencyPercentage,omitempty"`
